                            ...
                            <div class="card bg-light border-1 rounded-4 my-1 px-2 py-2">
                                <div class="card-body py-2 fs-6">
                                    <p class="card-text mb-2">
                                        ...
                                        <small class="text-muted" style="font-size: 0.8rem;"> | Uploaded by: {{ $pdf->uploaded_by }}</small>
                                    </p>
                                    <h6 class="card-title mb-2" style="font-size: 1.3rem;">{{ $pdf->file_name }}</h6>
                                    <span class="badge bg-success" style="font-size: 0.8rem;font-weight: normal; padding: 0.6em 1em;">Success</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
