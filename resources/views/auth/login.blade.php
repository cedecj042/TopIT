        ...
        <div class="row vh-100">
            <div class="col-md-7 d-flex align-items-center">
                <div class="p-5">
                    ...
                    <div class="text-start mt-5">
                        <h4 class="h4 fw-semibold text-blue-800 mb-3">Master Your IT Competency</h4>
            ...
            <div class="col-md-5 bg-light d-flex align-items-center">
                <div class="w-100 px-5 m-5">
                    ...
                    <div class="mt-3">
                        <a href="#" class="text-dark" style="font-size: 0.8rem; text-decoration-line: none;">Forgot Password?</a>
                    </div>
                    <div class="mt-5 text-center">
                        <a href="#" class="text-dark no-underline" style="font-size: 0.8rem; text-decoration-line: none;">Register Now</a>
                    </div>
                </div>
            </div>
        </div>
