<div class="col-auto col-md-4 col-xl-2 py-4 px-0 side-bar d-flex flex-column justify-content-between h-100" style="background: linear-gradient(to top, #114A91, #1C81F8);">
    <div class="d-flex flex-column justify-space-between pt-2">
        ...
        <ul class="nav nav-pills d-flex flex-column align-items-center" id="menu">
            ...
            <li class="nav-item w-100">
                <a href="{{ route('admin.course.index') }}" class="nav-link text-white py-3 ps-4 d-flex align-items-center gap-1"
                    id="admin.course.index" data-page="admin.course.index">
            ...
            <li class="nav-item w-100">
                <a href="{{ route('admin.questions.index') }}" class="nav-link text-white py-3 ps-4 d-flex align-items-center gap-1" id="test-link"
            ...
            <li class="nav-item w-100">
                <a href="{{ route('admin.users.index') }}" class="nav-link text-white py-3 ps-4 d-flex align-items-center gap-1" id="users-link"
