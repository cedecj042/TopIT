    ...
    <div class="d-flex flex-column justify-space-between pt-2">
        ...
        <ul class="nav nav-pills d-flex flex-column align-items-center" id="menu">
            <li class="nav-item w-100">
                <a href="{{ route('dashboard') }}" class="nav-link text-white py-3 ps-4 d-flex align-items-center gap-1"
            ...
            <li class="nav-item w-100">
                <a href="{{ route('test') }}" class="nav-link text-white py-3 ps-4 d-flex align-items-center gap-1" id="test"
                    data-page="test">
