            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="" method="POST"> 
                        {{-- {{ route('pretest.submit', ['number' => $number]) }} --}}
                        @csrf
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            @if($hasPrev)
                            <a href="{{ route('pretest.question', ['number' => $number - 1]) }}" class="btn btn-outline-primary">
                            ...
                            @else
                            <button type="submit" class="btn btn-primary">Finish Attempt</button>
                            @endif
                        </div>
                    </form>
                </div>
