                ...
                foreach (['Very Easy', 'Easy', 'Average', 'Hard', 'Very Hard'] as $index => $difficultyName) {
                    ...
                    if (empty($questionData[2])) {
                        ...
                        DB::table('questions')->insert([
                            ...
                            'questionable_type' => 'App\\Models\\Identification',
                        ...
                        if (!is_array(json_decode($questionData[1], true))) {
                            ...
                            DB::table('questions')->insert([
                                ...
                                'questionable_type' => 'App\\Models\\MultiChoiceSingle',
                                'difficulty_id' => $difficulties[$difficultyName]->difficulty_id,
                                'question' => $questionData[0],
                                'discrimination_index' => rand(-1, 1),
                                'created_at' => now(),
                            ...
                            DB::table('multichoice_many')->insert([
                                ...
                                'answers' => $questionData[1], // answers are already encoded
                                'choices' => $choices,
                                'created_at' => now(),
                                'updated_at' => now(),
                            ]);
                            ...
                            DB::table('questions')->insert([
                                ...
                                'questionable_type' => 'App\\Models\\MultiChoiceMany',
                                'difficulty_id' => $difficulties[$difficultyName]->difficulty_id,
                                'question' => $questionData[0],
                                'discrimination_index' => rand(-1, 1),
                                'created_at' => now(),
